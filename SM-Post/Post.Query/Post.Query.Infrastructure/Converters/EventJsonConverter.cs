...
{
    public class EventJsonConverter : JsonConverter<BaseEvents>
    {

        public override bool CanConvert(Type typeToConvert)
        {
            return typeToConvert.IsAssignableFrom(typeof(BaseEvents));
        }
        ...
        public override BaseEvents? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return typeDiscriminator switch
            {
                ...
                _=> throw new JsonException($"{typeDiscriminator} is not yet supported!")
            };
        }

        public override void Write(Utf8JsonWriter writer, BaseEvents value, JsonSerializerOptions options)
        {
